...
struct QueryLevel {
  ...
  QueryLevel(MEM_ROOT *mem_root, Surrounding_context sc, bool has_order = false)
      : m_type(sc), m_elts(Mem_root_allocator<Query_term*>(mem_root)), m_has_order(has_order) {}
};
/**
...
struct Parse_context {
  ...
  std::list<QueryLevel, Mem_root_allocator<QueryLevel> > m_stack;  ///< Aids query term tree construction
